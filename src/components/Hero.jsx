...
export default function Hero() {
  ...
  return (
    <section 
      id="home" 
      className="relative min-h-[100svh] w-full bg-[#070709] text-white flex flex-col justify-between pt-24 sm:pt-28 pb-10 px-5 sm:px-12 lg:px-20 select-none overflow-hidden"
    >
      {/* Desktop Centered Layer: Hidden on mobile so text never overlaps face */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 my-auto">
        ...
        {/* Mobile Dedicated Turnaround Stage (Clear view of hair, face, and suit) */}
        <div className="md:hidden w-full flex items-center justify-center py-2">
          <div className="relative w-full max-w-xs h-[42vh] flex items-center justify-center overflow-hidden">
            <img
              src="/images/me.gif"
              alt="Binoj 360 Turnaround"
        ...
        {/* Bottom / Right: Specialty Scope & CTAs */}
